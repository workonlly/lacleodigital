  ...
  return (<>
    ...
    <div style={{ maxWidth: 900, margin: '0 auto', padding: 24 }}>
      ...
      <ul>
        ...
        <li><strong>Company</strong> (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to La Cleo Digital Private Limited, B-401, The Jewel of Dasnaq, Sector – 75, Noida 201301.</li>
        ...
        <li><strong>Website</strong> refers to La Cleo Digital, accessible from <a href="https://lacleodigital.com" target="_blank" rel="noopener noreferrer">https://lacleodigital.com</a></li>
      ...
      <ul>
        <li><strong>Necessary / Essential Cookies</strong> (Session Cookies, administered by Us): These Cookies are essential to provide You with services available through the Website and to enable You to use some of its features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies, the services that You have asked for cannot be provided, and We only use these Cookies to provide You with those services.</li>
        ...
        <li><strong>Functionality Cookies</strong> (Persistent Cookies, administered by Us): These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Website.</li>
      </ul>
      <p>
      ...
      <p>
        ...
        By email: <a href="mailto:info@lacleodigital.com">info@lacleodigital.com</a><br />
        By visiting this page on our website: <a href="https://www.lacleodigital.com" target="_blank" rel="noopener noreferrer">https://www.lacleodigital.com</a>
      </p>
    </div>
    <Footer></Footer>
    </>
